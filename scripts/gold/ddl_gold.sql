...
/* Drop existing view if already created */
...
SELECT 'dim_customers view created successfully' AS message;
...
SELECT 'dim_products view created successfully' AS message;
...
SELECT 'fact_sales view created successfully' AS message;
